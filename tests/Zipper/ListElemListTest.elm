...
suite =
    describe "Zipper.ListElemList"
        ...
        , describe "Zipper.ListElemList.getAt"
            [ test "handles basic operation" <|
                \_ ->
                    let
                        zipper =
                    ...
                    in
                    List.map
                        (\i -> Zipper.ListElemList.getAt i zipper)
                        (List.range -1 7)
                        |> Expect.equal
                            [ Nothing
                            , Just 1
        ...
        , describe "Zipper.ListElemList.getAtClamp"
            [ test "handles basic operation" <|
                \_ ->
                    let
                        zipper =
                    ...
                    in
                    List.map
                        (\i -> Zipper.ListElemList.getAtClamp i zipper)
                        (List.range -1 7)
                        |> Expect.equal
                            [ 1
                            , 1
        ...
        , describe "Zipper.ListElemList.getAtRelative"
            [ test "handles basic operation" <|
                \_ ->
                    let
                        zipper =
                    ...
                    in
                    List.map
                        (\i -> Zipper.ListElemList.getAtRelative i zipper)
                        (List.range -4 4)
                        |> Expect.equal
                            [ Nothing
                            , Just 1
        ...
        , describe "Zipper.ListElemList.getAtRelativeClamp"
            [ test "handles basic operation" <|
                \_ ->
                    let
                        zipper =
                    ...
                    in
                    List.map
                        (\i -> Zipper.ListElemList.getAtRelativeClamp i zipper)
                        (List.range -4 4)
                        |> Expect.equal
                            [ 1
                            , 1
